...
public class CheapOAir {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement radio = driver.findElement(By.id("onewayTrip"));
		((JavascriptExecutor) driver).executeScript("arguments[0].click();",radio);
		Thread.sleep(2000);

		
		System.out.println("hi");
		driver.findElement(By.id("from0")).sendKeys("MAA",Keys.TAB,Keys.TAB,Keys.TAB,Keys.DELETE);
		WebElement textBox=driver.findElement(By.id("to0"));
		textBox.clear();
		WebElement to = driver.findElement(By.id("to0"));
		to.sendKeys("BLR");
		Thread.sleep(2000);
