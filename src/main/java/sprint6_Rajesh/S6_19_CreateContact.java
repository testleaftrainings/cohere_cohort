...
public class S6_19_CreateContact extends BaseClass  {
	...
	public  void s6_019_Create_Contact() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//div[contains(@id,'toastDescription')]//following::button")))).click();
		//		Click and save
		...
		String valid = toast.getText();
		String exp = name+" "+ lastName;
