...
public class EditOpportunity15 {
...
//			searchInput.click();
		...
		WebElement dropdown = driver
				.findElement(By.xpath("//records-record-layout-item[@field-label='Stage']//button[@role='combobox']"));
		dropdown.click();

		driver.findElement(By
				.xpath("//div//*[@aria-label='Stage']/lightning-base-combobox-item[@data-value='Perception Analysis']"))
				.click();
		Thread.sleep(5000);
...
//			WebElement delivery = driver.findElement(By.xpath("//button[@aria-label='Delivery/Installation Status']//span"));
		WebElement delivery = driver
				.findElement(By.xpath("(//label[text()='Delivery/Installation Status']//following::div//button)[1]"));
