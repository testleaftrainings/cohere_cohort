...
public class UpdateContacts {
	...
	public void editOppMethod() throws InterruptedException
	{
		...
		names = driver.findElements(By.xpath("//th[@data-aura-class=\"forceInlineEditCell\"]//a"));
			...
			leadSource.click();
			Thread.sleep(4000);
			WebElement partner = driver.findElement(By.xpath("//lightning-base-combobox-item[@data-value='Partner Referral']"));
			Thread.sleep(5000);
			...
			WebElement teritory = driver.findElement(By.xpath("//div/lightning-base-combobox-item//span[@title=\"Tertiary\"]"));
			...
			String emailVali = driver.findElement(By.xpath("(//span[@data-aura-class=\"forceInlineEditCell\"]/a)[2]")).getText();
