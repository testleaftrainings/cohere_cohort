...
//		driver.findElement(By.linkText("Campaigns")).click();
		...
		WebElement search = driver.findElement(By.xpath("(//lightning-icon[@icon-name='utility:search']//span[@part='boundary'])[2]"));
		...
		driver.findElement(By.xpath("(//label//span[text()='Company']//parent::label//following::input)[1]")).sendKeys("TestLeaf");
		driver.findElement(By.xpath("//button[@title=\"Save\"]//span[text()='Save']")).click();
		Thread.sleep(1000);
		String text = driver.findElement(By.xpath("//div[@data-aura-class='forceToastMessage']//..//span[contains(text(),'Lead')]")).getText();
		...
		Thread.sleep(1000);
		String text1 = driver.findElement(By.xpath("(//div[@data-aura-class='forceToastMessage']//..//div[contains(text(),'Bootcamp')])[1]")).getText();
...
//		campaign.click();
		...
		Thread.sleep(2000);
		String status = driver.findElement(By.xpath("//div//span[@title='Campaign History']//following::div//a[text()='Bootcamp']")).getText();
